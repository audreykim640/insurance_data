...
link <- "https://www.kff.org/interactive/subsidy-calculator/#state=STATEABBR&zip=ZIPCODE&income-type=dollars&income=500%2C000&people=1&alternate-plan-family=&adult-count=1&adults%5B0%5D%5Bage%5D=64&adults%5B0%5D%5Btobacco%5D=0&child-count=0"
...
# test_link <- "https://www.kff.org/interactive/subsidy-calculator/#state=il&zip=60901&income-type=dollars&income=500%2C000&people=1&alternate-plan-family=&adult-count=1&adults%5B0%5D%5Bage%5D=64&adults%5B0%5D%5Btobacco%5D=0&child-count=0"
# 
# get_insurance_price(remDr, test_link)

zips_head <-head(zips_urls)

prices <- map(zips_urls$kff_url, get_insurance_price, remDr = remDr) |>
  unlist()

full_df <- cbind(zips_urls, prices)

test <- map(test$kff_url, get_insurance_price, remDr = remDr)


remDr$navigate("https://www.kff.org/interactive/subsidy-calculator/#state=il&zip=60901&income-type=dollars&income=500%2C000&people=1&alternate-plan-family=&adult-count=1&adults%5B0%5D%5Bage%5D=64&adults%5B0%5D%5Btobacco%5D=0&child-count=0")
