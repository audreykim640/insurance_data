...
test_link <- "https://www.kff.org/interactive/subsidy-calculator/#state=il&zip=60901&income-type=dollars&income=500%2C000&people=1&alternate-plan-family=&adult-count=1&adults%5B0%5D%5Bage%5D=AGENUM&adults%5B0%5D%5Btobacco%5D=0&child-count=0"
# 
...
get_prices_by_age_df <- function(remDr, ages, url) {
  ...
  prices_df <- cbind(prices20, prices30, prices40, prices50, prices60)
  prices_df

}

get_prices_by_age_df(remDr, ages, test_link)
